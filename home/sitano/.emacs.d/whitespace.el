...
<h1><a title="Click to search for references to this page" rel="nofollow" href="http://www.google.com/cse?cx=004774160799092323420:6-ff2s0o6yi&amp;q=%22whitespace.el%22">whitespace.el</a></h1></div><div class="wrapper"><div class="wrapper"><div class="content browse"><p class="download"><a href="http://www.emacswiki.org/emacs/download/whitespace.el">Download</a></p><pre class="code"><span class="linecomment">;;; whitespace.el --- minor mode to visualize TAB, (HARD) SPACE, NEWLINE</span>

<span class="linecomment">;; Copyright (C) 2000-2011  Free Software Foundation, Inc.</span>
...
<span class="linecomment">;; Version: 13.2.2</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;; The trailing spaces are not highlighted while point is at end of line.</span>
<span class="linecomment">;; Also the spaces at beginning of buffer are not highlighted while point is at</span>
<span class="linecomment">;; beginning of buffer; and the spaces at end of buffer are not highlighted</span>
<span class="linecomment">;; while point is at end of buffer.</span>
<span class="linecomment">;;</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;;    (require 'whitespace)</span>
<span class="linecomment">;;</span>
...
<span class="linecomment">;; ----------------</span>
<span class="linecomment">;;</span>
<span class="linecomment">;; Thanks to felix (EmacsWiki) for keeping highlight when switching between</span>
<span class="linecomment">;; major modes on a file.</span>
<span class="linecomment">;;</span>
...
(eval-and-compile
  (unless (fboundp 'with-current-buffer)
    <span class="linecomment">;; from `subr.el' (Emacs 23)</span>
    (defmacro with-current-buffer (buffer-or-name &rest body)
      "<span class="quote">Execute the forms in BODY with BUFFER-OR-NAME temporarily current.
BUFFER-OR-NAME must be a buffer or the name of an existing buffer.
The value returned is the value of the last form in BODY.  See
also `with-temp-buffer'.</span>"
...
See also `whitespace-display-mappings' for documentation.</span>"
  :type '(repeat :tag "<span class="quote">Kind of Blank</span>"
		 (choice :tag "<span class="quote">Kind of Blank Face</span>"
			 (const :tag "<span class="quote">(Face) Face visualization</span>"
				face)
...
(defface whitespace-space
  '((((class color) (background dark))
     (:background "<span class="quote">grey20</span>"      :foreground "<span class="quote">darkgray</span>"))
    (((class color) (background light))
     (:background "<span class="quote">LightYellow</span>" :foreground "<span class="quote">lightgray</span>"))
    (t (:inverse-video t)))
...
(defface whitespace-hspace		<span class="linecomment">; 'nobreak-space</span>
  '((((class color) (background dark))
     (:background "<span class="quote">grey24</span>"        :foreground "<span class="quote">darkgray</span>"))
    (((class color) (background light))
     (:background "<span class="quote">LemonChiffon3</span>" :foreground "<span class="quote">lightgray</span>"))
    (t (:inverse-video t)))
...
(defface whitespace-tab
  '((((class color) (background dark))
     (:background "<span class="quote">grey22</span>" :foreground "<span class="quote">darkgray</span>"))
    (((class color) (background light))
     (:background "<span class="quote">beige</span>"  :foreground "<span class="quote">lightgray</span>"))
    (t (:inverse-video t)))
...
Used when `whitespace-style' includes `lines' or `lines-tail'.</span>"
  :type '(choice :tag "<span class="quote">Line Length Limit</span>"
		 (integer :tag "<span class="quote">Line Length</span>")
		 (const :tag "<span class="quote">Use fill-column</span>" nil))
  :group 'whitespace)
...
(defcustom whitespace-display-mappings
  (if (&gt;= emacs-major-version 23)
      ...
      '(
	(space-mark   ?\     [?\u00B7]     [?.]) <span class="linecomment">; space - centered dot</span>
	(space-mark   ?\xA0  [?\u00A4]     [?_]) <span class="linecomment">; hard space - currency</span>
	...
	(tab-mark     ?\t    [?\u00BB ?\t] [?\\ ?\t]) <span class="linecomment">; tab - left quote mark</span>
	)
...
(define-minor-mode whitespace-mode
  "<span class="quote">Toggle whitespace visualization (Whitespace mode).
...
(define-minor-mode whitespace-newline-mode
  "<span class="quote">Toggle newline visualization (Whitespace Newline mode).
...
(define-minor-mode global-whitespace-mode
  "<span class="quote">Toggle whitespace visualization globally (Global Whitespace mode).
...
(define-minor-mode global-whitespace-newline-mode
  "<span class="quote">Toggle global newline visualization (Global Whitespace Newline mode).
...
(defvar whitespace-point (point)
  "<span class="quote">Used to save locally current point value.
Used by `whitespace-trailing-regexp' function (which see).</span>")

(defvar whitespace-font-lock-refontify nil
  "<span class="quote">Used to save locally the font-lock refontify state.
Used by `whitespace-post-command-hook' function (which see).</span>")

(defvar whitespace-bob-marker nil
  "<span class="quote">Used to save locally the bob marker value.
Used by `whitespace-post-command-hook' function (which see).</span>")

(defvar whitespace-eob-marker nil
  "<span class="quote">Used to save locally the eob marker value.
Used by `whitespace-post-command-hook' function (which see).</span>")

(defvar whitespace-buffer-changed nil
  "<span class="quote">Used to indicate locally if buffer changed.
	...
	(when (memq 'empty whitespace-style)
	  (let (overwrite-mode)		<span class="linecomment">; enforce no overwrite</span>
	    ...
	    (when (re-search-forward
		   (concat "<span class="quote">\\`</span>" whitespace-empty-at-bob-regexp) nil t)
	      (delete-region (match-beginning 1) (match-end 1)))
	    (when (re-search-forward
		   (concat whitespace-empty-at-eob-regexp "<span class="quote">\\'</span>") nil t)
	      (delete-region (match-beginning 1) (match-end 1)))))))
    <span class="linecomment">;; PROBLEM 3: 8 or more SPACEs at bol</span>
    <span class="linecomment">;; PROBLEM 4: SPACEs before TAB</span>
    <span class="linecomment">;; PROBLEM 5: SPACEs or TABs at eol</span>
...
(defun whitespace-display-window (buffer)
  ...
  (when (&lt; (window-height) (* 2 window-min-height))
    (kill-buffer buffer)
    (error "<span class="quote">Window height is too small; \
...
(defun whitespace-help-scroll (&optional up)
  "<span class="quote">Scroll help window, if it exists.

If UP is non-nil, scroll up; otherwise, scroll down.</span>"
  (condition-case nil
    ...
    ((error)
     <span class="linecomment">;; just ignore error</span>
     )))
...
See also `whitespace-toggle-option-alist'.</span>"
  (let* ((is-off (not (if local-p
    ...
    (list sym)))			<span class="linecomment">; return the appropriate symbol</span>
...
(defun whitespace-color-on ()
  ...
  (when (whitespace-style-face-p)
    ...
    <span class="linecomment">;; save current point and refontify when necessary</span>
...
(defun whitespace-trailing-regexp (limit)
  "<span class="quote">Match trailing spaces which do not contain the point at end of line.</span>"
  (let ((status t))
    (while (if (re-search-forward whitespace-trailing-regexp limit t)
	       (= whitespace-point (match-end 1)) <span class="linecomment">;; loop if point at eol</span>
	     (setq status nil)))		  <span class="linecomment">;; end of buffer</span>
    status))


(defun whitespace-empty-at-bob-regexp (limit)
  "<span class="quote">Match spaces at beginning of buffer which do not contain the point at \
beginning of buffer.</span>"
  (let ((b (point))
	r)
    (cond
     <span class="linecomment">;; at bob</span>
     ((= b 1)
     ...
     <span class="linecomment">;; inside bob empty region</span>
	...
	(set-marker whitespace-bob-marker b)))
     <span class="linecomment">;; intersection with end of bob empty region</span>
     ((&lt;= b whitespace-bob-marker)
      (setq r (looking-at whitespace-empty-at-bob-regexp))
      (set-marker whitespace-bob-marker (if r (match-end 1) b)))
     <span class="linecomment">;; it is not inside bob empty region</span>
     (t
      (setq r nil)))
    <span class="linecomment">;; move to end of matching</span>
...
(defsubst whitespace-looking-back (regexp limit)
  (save-excursion
    (when (/= 0 (skip-chars-backward "<span class="quote"> \t\n</span>" limit))
      (unless (bolp)
	(forward-line 1))
      (looking-at regexp))))
...
(defun whitespace-empty-at-eob-regexp (limit)
  "<span class="quote">Match spaces at end of buffer which do not contain the point at end of \
buffer.</span>"
  (let ((b (point))
	(e (1+ (buffer-size)))
	r)
    (cond
     <span class="linecomment">;; at eob</span>
     ((= limit e)
	...
	(goto-char b)))			<span class="linecomment">; return back to initial position</span>
     <span class="linecomment">;; inside eob empty region</span>
	...
	(set-marker whitespace-eob-marker limit)
	(goto-char b)))			<span class="linecomment">; return back to initial position</span>
     <span class="linecomment">;; intersection with beginning of eob empty region</span>
	...
	(set-marker whitespace-eob-marker limit)
	(goto-char b)))			<span class="linecomment">; return back to initial position</span>
     <span class="linecomment">;; it is not inside eob empty region</span>
     (t
      (setq r nil)))
    r))
...
(defun whitespace-buffer-changed (_beg _end)
  "<span class="quote">Set `whitespace-buffer-changed' variable to t.</span>"
  (setq whitespace-buffer-changed t))


(defun whitespace-post-command-hook ()
  "<span class="quote">Save current point into `whitespace-point' variable.
Also refontify when necessary.</span>"
  (setq whitespace-point (point))	<span class="linecomment">; current point position</span>
  (let ((refontify
	 (or
	  <span class="linecomment">;; it is at end of line ...</span>
	  (and (eolp)
	       <span class="linecomment">;; ... with trailing SPACE or TAB</span>
	       (or (= (preceding-char) ?\ )
		   (= (preceding-char) ?\t)))
	  <span class="linecomment">;; it is at beginning of buffer (bob)</span>
	  (= whitespace-point 1)
	  <span class="linecomment">;; the buffer was modified and ...</span>
	  (and whitespace-buffer-changed
	       (or
		<span class="linecomment">;; ... or inside bob whitespace region</span>
		(&lt;= whitespace-point whitespace-bob-marker)
		<span class="linecomment">;; ... or at bob whitespace region border</span>
		(and (= whitespace-point (1+ whitespace-bob-marker))
		     (= (preceding-char) ?\n))))
	  <span class="linecomment">;; it is at end of buffer (eob)</span>
	  (= whitespace-point (1+ (buffer-size)))
	  <span class="linecomment">;; the buffer was modified and ...</span>
	  (and whitespace-buffer-changed
	       (or
		<span class="linecomment">;; ... or inside eob whitespace region</span>
	        (&gt;= whitespace-point whitespace-eob-marker)
		<span class="linecomment">;; ... or at eob whitespace region border</span>
    ...
    (when (or refontify (&gt; whitespace-font-lock-refontify 0))
      ...
      <span class="linecomment">;; adjust refontify counter</span>
      (setq whitespace-font-lock-refontify
	    (if refontify
		1
	      (1- whitespace-font-lock-refontify)))
      <span class="linecomment">;; refontify</span>
      (jit-lock-refontify))))
...
(defun whitespace-display-char-on ()
  ...
  (when (and whitespace-display-mappings
	...
	<span class="linecomment">;; asure `buffer-display-table' is unique</span>
	<span class="linecomment">;; when two or more windows are visible.</span>
	...
	(when (memq (car entry) whitespace-style)
	  ...
	  (when vecs
		...
		<span class="linecomment">;; code can not be above ?\x1FFFF.  This is already</span>
		<span class="linecomment">;; fixed in Emacs 23.</span>
		(or (eq (aref vec i) ?\n)
...
<span class="linecomment">;;; whitespace.el ends here</span></span></pre></div><div class="wrapper close"></div></div><div class="wrapper close"></div></div><div class="footer"><hr /><span class="gotobar bar"><a class="local" href="http://www.emacswiki.org/emacs/SiteMap">SiteMap</a> <a class="local" href="http://www.emacswiki.org/emacs/Search">Search</a> <a class="local" href="http://www.emacswiki.org/emacs/ElispArea">ElispArea</a> <a class="local" href="http://www.emacswiki.org/emacs/HowTo">HowTo</a> <a class="local" href="http://www.emacswiki.org/emacs/Glossary">Glossary</a> <a class="local" href="http://www.emacswiki.org/emacs/RecentChanges">RecentChanges</a> <a class="local" href="http://www.emacswiki.org/emacs/News">News</a> <a class="local" href="http://www.emacswiki.org/emacs/Problems">Problems</a> <a class="local" href="http://www.emacswiki.org/emacs/Suggestions">Suggestions</a> </span><span class="translation bar"><br />  <a class="translation new" rel="nofollow" href="http://www.emacswiki.org/emacs?action=translate;id=whitespace.el;missing=de_es_fr_it_ja_ko_pt_ru_se_zh">Add Translation</a></span><span class="edit bar"><br /> <a class="comment local" href="http://www.emacswiki.org/emacs/Comments_on_whitespace.el">Talk</a> <a class="edit" accesskey="e" title="Click to edit this page" rel="nofollow" href="http://www.emacswiki.org/emacs?action=edit;id=whitespace.el">Edit this page</a> <a class="history" rel="nofollow" href="http://www.emacswiki.org/emacs?action=history;id=whitespace.el">View other revisions</a> <a class="admin" rel="nofollow" href="http://www.emacswiki.org/emacs?action=admin;id=whitespace.el">Administration</a></span><!-- test --><span class="time"><br /> Last edited 2011-10-31 01:13 UTC by <a class="author" title="from bb6a3db8.virtua.com.br" href="http://www.emacswiki.org/emacs/viniciusjl">viniciusjl</a> <a class="diff" rel="nofollow" href="http://www.emacswiki.org/emacs?action=browse;diff=2;id=whitespace.el">(diff)</a></span><div style="float:right; margin-left:1ex;">
